        ...
        static void Main(string[] args)
        {
            ...
            using (connection)
            {
                ...
                using (createDbCommand)
                {
                    ...
                    {
                        Console.WriteLine("An error occured while creating database!");
            ...
            using (connection)
            {
                ...
                SqlCommand createTables = new SqlCommand(queryText, connection);
                ...
                using (createTables)
                {
                    ...
                    {
                        Console.WriteLine("An error occured while creating tables!");
                        Console.WriteLine(e.Message);
                        return;
                    }
                }
                ...
                using (insertCmd)
                {
                    try
                    {
                        ...
                        Console.WriteLine("Tables info inserted successfully.");
                    }
                    catch (Exception e)
                    {
                        Console.WriteLine("An error occured while creating tables!");
